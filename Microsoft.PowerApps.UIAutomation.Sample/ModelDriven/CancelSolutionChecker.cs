...
{
    [TestClass]
    public class CancelSolutionChecker
    {
        ...
        [TestMethod]
        public void TestCancelSolutionChecker()
        {
            ...
            using (var appBrowser = new PowerAppBrowser(TestSettings.Options))
            {
                try
                {
                    ...
                    Console.WriteLine($"Attempt to cancel the solution checker run...");
                    appBrowser.ModelDrivenApps.CancelSolutionChecker(_solutionName);
                ...
                {
                    Console.WriteLine($"An error occurred attempting to cancel Solution Checker test run for solution {_solutionName}: {e}");
